...
export interface ILEDAInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ILEDA extends BaseContract {
  connect(runner?: ContractRunner | null): ILEDA;
  waitForDeployment(): Promise<this>;

  interface: ILEDAInterface;
