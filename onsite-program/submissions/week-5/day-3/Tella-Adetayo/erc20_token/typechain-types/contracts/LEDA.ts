...
export interface LEDAInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface LEDA extends BaseContract {
  connect(runner?: ContractRunner | null): LEDA;
  waitForDeployment(): Promise<this>;

  interface: LEDAInterface;
