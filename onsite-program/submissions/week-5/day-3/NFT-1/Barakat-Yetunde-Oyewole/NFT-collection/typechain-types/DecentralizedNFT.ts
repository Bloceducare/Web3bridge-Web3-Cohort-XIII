...
export interface DecentralizedNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
      | "approve"
...
export interface DecentralizedNFT extends BaseContract {
  connect(runner?: ContractRunner | null): DecentralizedNFT;
  waitForDeployment(): Promise<this>;

  interface: DecentralizedNFTInterface;
  ...
  tokenExists: TypedContractMethod<[arg0: BigNumberish], [boolean], "view">;
