...
export interface MartinsNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
      | "approve"
...
export interface MartinsNFT extends BaseContract {
  connect(runner?: ContractRunner | null): MartinsNFT;
  waitForDeployment(): Promise<this>;

  interface: MartinsNFTInterface;
  ...
  batchMint: TypedContractMethod<
    [recipients: AddressLike[], tokenURIs: string[]],
    [void],
    "payable"
  >;
