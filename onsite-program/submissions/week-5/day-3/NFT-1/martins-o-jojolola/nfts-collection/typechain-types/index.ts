...
export type { MartinsNFT } from "./contracts/MyNFTsCollection.sol/MartinsNFT";
export { MartinsNFT__factory } from "./factories/contracts/MyNFTsCollection.sol/MartinsNFT__factory";
