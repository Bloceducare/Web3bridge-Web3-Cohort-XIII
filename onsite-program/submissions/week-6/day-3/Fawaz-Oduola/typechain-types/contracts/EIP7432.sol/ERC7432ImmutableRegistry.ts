...
export interface ERC7432ImmutableRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "grantRole"
  ...
  encodeFunctionData(
    functionFragment: "originalOwners",
  ...
  encodeFunctionData(
    functionFragment: "roleExpirationDates",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface ERC7432ImmutableRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): ERC7432ImmutableRegistry;
  waitForDeployment(): Promise<this>;

  interface: ERC7432ImmutableRegistryInterface;
  ...
  originalOwners: TypedContractMethod<
  ...
  roleExpirationDates: TypedContractMethod<
    [arg0: AddressLike, arg1: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "originalOwners"
  ): TypedContractMethod<
    [arg0: AddressLike, arg1: BigNumberish],
    [string],
    "view"
  ...
  >;
  getFunction(
    nameOrSignature: "roleExpirationDates"
  ): TypedContractMethod<
    [arg0: AddressLike, arg1: BigNumberish],
    [bigint],
    "view"
