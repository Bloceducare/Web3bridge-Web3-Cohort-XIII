...
export interface RolesRegistry7432Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "grantRole"
      | "hasRole"
...
export interface RolesRegistry7432 extends BaseContract {
  connect(runner?: ContractRunner | null): RolesRegistry7432;
  waitForDeployment(): Promise<this>;

  interface: RolesRegistry7432Interface;
