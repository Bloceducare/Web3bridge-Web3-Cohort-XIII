...
export interface IRolesRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getRoleWeight"
      | "grantRole"
...
export interface IRolesRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): IRolesRegistry;
  waitForDeployment(): Promise<this>;

  interface: IRolesRegistryInterface;
