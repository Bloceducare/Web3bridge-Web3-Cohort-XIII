...
interface IFactory {
    function createPiggyBank(address token, uint256 lockPeriodSeconds) external returns (address child); 
    ...
    function updateAggregateOnWithDraw(address user, uint256 amount) external;
