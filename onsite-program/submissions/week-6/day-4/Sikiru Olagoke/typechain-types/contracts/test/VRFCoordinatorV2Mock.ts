...
export interface VRFCoordinatorV2MockInterface extends utils.Interface {
  ...
  events: {
    "AddedRandomWord(uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "AddedRandomWord"): EventFragment;
...
export interface AddedRandomWordEventObject {
  randomWord: BigNumber;
}
export type AddedRandomWordEvent = TypedEvent<
  [BigNumber],
  AddedRandomWordEventObject
>;

export type AddedRandomWordEventFilter = TypedEventFilter<AddedRandomWordEvent>;
...
export interface VRFCoordinatorV2Mock extends BaseContract {
  ...
  filters: {
    "AddedRandomWord(uint256)"(randomWord?: null): AddedRandomWordEventFilter;
    AddedRandomWord(randomWord?: null): AddedRandomWordEventFilter;
