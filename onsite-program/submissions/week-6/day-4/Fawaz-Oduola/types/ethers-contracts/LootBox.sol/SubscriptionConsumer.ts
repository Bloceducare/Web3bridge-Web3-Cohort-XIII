...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface SubscriptionConsumerInterface extends Interface {
    getFunction(nameOrSignature: "acceptOwnership" | "callbackGasLimit" | "getRequestStatus" | "getReward" | "keyHash" | "lastRequestId" | "numWords" | "openBox" | "owner" | "rawFulfillRandomWords" | "requestConfirmations" | "requestIds" | "s_requests" | "s_subscriptionId" | "s_vrfCoordinator" | "setCoordinator" | "transferOwnership" | "withdraw"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "CoordinatorSet" | "OwnershipTransferRequested" | "OwnershipTransferred" | "RequestFulfilled" | "RequestSent" | "WonERC1155" | "WonERC20" | "WonERC721"): EventFragment;
...
decodeFunctionResult(functionFragment: 'withdraw', data: BytesLike): Result;
    ...
    export namespace WonERC1155Event {
    ...
    export namespace WonERC20Event {
      export type InputTuple = [winner: AddressLike];
      export type OutputTuple = [winner: string];
      export interface OutputObject {winner: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
    ...
    export namespace WonERC721Event {
      export type InputTuple = [winner: AddressLike];
      export type OutputTuple = [winner: string];
      export interface OutputObject {winner: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
...
getEvent(key: 'WonERC1155'): TypedContractEvent<WonERC1155Event.InputTuple, WonERC1155Event.OutputTuple, WonERC1155Event.OutputObject>;
getEvent(key: 'WonERC20'): TypedContractEvent<WonERC20Event.InputTuple, WonERC20Event.OutputTuple, WonERC20Event.OutputObject>;
getEvent(key: 'WonERC721'): TypedContractEvent<WonERC721Event.InputTuple, WonERC721Event.OutputTuple, WonERC721Event.OutputObject>;
    ...
    filters: {
      ...
      'WonERC1155(address)': TypedContractEvent<WonERC1155Event.InputTuple, WonERC1155Event.OutputTuple, WonERC1155Event.OutputObject>;
      WonERC1155: TypedContractEvent<WonERC1155Event.InputTuple, WonERC1155Event.OutputTuple, WonERC1155Event.OutputObject>;
    

      'WonERC20(address)': TypedContractEvent<WonERC20Event.InputTuple, WonERC20Event.OutputTuple, WonERC20Event.OutputObject>;
      WonERC20: TypedContractEvent<WonERC20Event.InputTuple, WonERC20Event.OutputTuple, WonERC20Event.OutputObject>;
    

      'WonERC721(address)': TypedContractEvent<WonERC721Event.InputTuple, WonERC721Event.OutputTuple, WonERC721Event.OutputObject>;
      WonERC721: TypedContractEvent<WonERC721Event.InputTuple, WonERC721Event.OutputTuple, WonERC721Event.OutputObject>;
