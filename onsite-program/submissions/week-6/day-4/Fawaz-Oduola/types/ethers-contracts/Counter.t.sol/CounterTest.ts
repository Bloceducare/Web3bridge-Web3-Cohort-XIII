...
export declare namespace StdInvariant {
    ...
    export type FuzzSelectorStruct = {addr: AddressLike, selectors: BytesLike[]}

    export type FuzzSelectorStructOutput = [addr: string, selectors: string[]] & {addr: string, selectors: string[] }
  

    export type FuzzArtifactSelectorStruct = {artifact: string, selectors: BytesLike[]}

    export type FuzzArtifactSelectorStructOutput = [artifact: string, selectors: string[]] & {artifact: string, selectors: string[] }
  ...
  export interface CounterTestInterface extends Interface {
    getFunction(nameOrSignature: "IS_TEST" | "excludeArtifacts" | "excludeContracts" | "excludeSelectors" | "excludeSenders" | "failed" | "setUp" | "targetArtifactSelectors" | "targetArtifacts" | "targetContracts" | "targetInterfaces" | "targetSelectors" | "targetSenders" | "test_InitialValue"): FunctionFragment;
...
encodeFunctionData(functionFragment: 'test_InitialValue', values?: undefined): string;
...
decodeFunctionResult(functionFragment: 'test_InitialValue', data: BytesLike): Result;
  }
    ...
    export namespace logEvent {
      ...
      export interface OutputObject {arg0: string };
    ...
    export namespace log_array_uint256_array_Event {
      ...
      export interface OutputObject {val: bigint[] };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace log_array_address_array_Event {
      ...
      export interface OutputObject {val: string[] };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace log_intEvent {
      ...
      export interface OutputObject {arg0: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace log_named_addressEvent {
      ...
      export interface OutputObject {key: string, val: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace log_named_array_string_uint256_array_Event {
      ...
      export interface OutputObject {key: string, val: bigint[] };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace log_named_decimal_intEvent {
      ...
      export interface OutputObject {key: string, val: bigint, decimals: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    excludeArtifacts: TypedContractMethod<
      [],
      [string[]],
      'view'
    >
    ...
    excludeContracts: TypedContractMethod<
      [],
      [string[]],
      'view'
    >
    ...
    excludeSenders: TypedContractMethod<
      [],
      [string[]],
      'view'
    >
    ...
    targetArtifacts: TypedContractMethod<
      [],
      [string[]],
      'view'
    >
    ...
    targetContracts: TypedContractMethod<
      [],
      [string[]],
      'view'
    >
    ...
    targetSenders: TypedContractMethod<
      [],
      [string[]],
      'view'
    >
    ...
    test_InitialValue: TypedContractMethod<
      [],
      [bigint],
      'nonpayable'
    >
    ...
    getFunction(nameOrSignature: 'IS_TEST'): TypedContractMethod<
      [],
      [boolean],
      'view'
    >;
getFunction(nameOrSignature: 'excludeArtifacts'): TypedContractMethod<
      [],
      [string[]],
      'view'
    >;
getFunction(nameOrSignature: 'excludeContracts'): TypedContractMethod<
      [],
      [string[]],
      'view'
    >;
getFunction(nameOrSignature: 'excludeSelectors'): TypedContractMethod<
      [],
      [StdInvariant.FuzzSelectorStructOutput[]],
      'view'
    >;
getFunction(nameOrSignature: 'excludeSenders'): TypedContractMethod<
      [],
      [string[]],
      'view'
    >;
getFunction(nameOrSignature: 'failed'): TypedContractMethod<
      [],
      [boolean],
      'view'
    >;
...
getFunction(nameOrSignature: 'targetArtifactSelectors'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'targetArtifacts'): TypedContractMethod<
      [],
      [string[]],
      'view'
    >;
getFunction(nameOrSignature: 'targetContracts'): TypedContractMethod<
      [],
      [string[]],
      'view'
    >;
getFunction(nameOrSignature: 'targetInterfaces'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'targetSelectors'): TypedContractMethod<
      [],
      [StdInvariant.FuzzSelectorStructOutput[]],
      'view'
    >;
getFunction(nameOrSignature: 'targetSenders'): TypedContractMethod<
      [],
      [string[]],
      'view'
    >;
getFunction(nameOrSignature: 'test_InitialValue'): TypedContractMethod<
      [],
      [bigint],
      'nonpayable'
    >;
