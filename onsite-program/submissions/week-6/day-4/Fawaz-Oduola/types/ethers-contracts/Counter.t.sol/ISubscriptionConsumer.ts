...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface ISubscriptionConsumerInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'requestRandomWords', data: BytesLike): Result;
  ...
  export interface ISubscriptionConsumer extends BaseContract {
    
    connect(runner?: ContractRunner | null): ISubscriptionConsumer;
    waitForDeployment(): Promise<this>;

    interface: ISubscriptionConsumerInterface;
