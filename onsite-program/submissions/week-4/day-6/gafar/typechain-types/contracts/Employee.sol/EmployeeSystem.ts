...
export interface EmployeeSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "createEmployee"
      | "deleteEmployee"
...
export interface EmployeeSystem extends BaseContract {
  connect(runner?: ContractRunner | null): EmployeeSystem;
  waitForDeployment(): Promise<this>;

  interface: EmployeeSystemInterface;
