...
export interface AMASInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_totalsupply"
      | "allowance"
...
export interface AMAS extends BaseContract {
  connect(runner?: ContractRunner | null): AMAS;
  waitForDeployment(): Promise<this>;

  interface: AMASInterface;
