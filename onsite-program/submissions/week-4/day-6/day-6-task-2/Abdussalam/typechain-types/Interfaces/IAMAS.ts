...
export interface IAMASInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface IAMAS extends BaseContract {
  connect(runner?: ContractRunner | null): IAMAS;
  waitForDeployment(): Promise<this>;

  interface: IAMASInterface;
