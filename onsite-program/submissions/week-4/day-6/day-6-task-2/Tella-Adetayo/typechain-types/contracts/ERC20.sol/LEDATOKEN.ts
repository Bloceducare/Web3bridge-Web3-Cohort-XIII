...
export interface LEDATOKENInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export namespace TransferEvent {
  ...
  export type OutputTuple = [_to: string, _from: string, _amount: bigint];
  export interface OutputObject {
    _to: string;
    _from: string;
    _amount: bigint;
...
export interface LEDATOKEN extends BaseContract {
  connect(runner?: ContractRunner | null): LEDATOKEN;
  waitForDeployment(): Promise<this>;

  interface: LEDATOKENInterface;
