...
export interface BilalEnterpriseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getAnEmployee"
      | "getBalance"
...
export interface BilalEnterprise extends BaseContract {
  connect(runner?: ContractRunner | null): BilalEnterprise;
  waitForDeployment(): Promise<this>;

  interface: BilalEnterpriseInterface;
