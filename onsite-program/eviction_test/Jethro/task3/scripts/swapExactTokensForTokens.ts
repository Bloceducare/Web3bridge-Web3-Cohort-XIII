...
async function main() {
  ...
  console.log("Expected Amount Out (DAI):", ethers.formatUnits(amountsOut[1].toString(), 18));
  console.log("Minimum Amount Out (DAI):", ethers.formatUnits(amountOutMin.toString(), 18));
  console.log();
