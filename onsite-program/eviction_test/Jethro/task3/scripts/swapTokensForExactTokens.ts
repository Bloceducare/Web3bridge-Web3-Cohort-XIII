...
async function main() {
  ...
  console.log("Desired Amount Out (DAI):", ethers.formatUnits(amountOut.toString(), 18));
  console.log("Required Amount In (USDC):", ethers.formatUnits(amountsIn[0].toString(), 6));
  console.log("Maximum Amount In (USDC):", ethers.formatUnits(amountInMax.toString(), 6));
  console.log();
