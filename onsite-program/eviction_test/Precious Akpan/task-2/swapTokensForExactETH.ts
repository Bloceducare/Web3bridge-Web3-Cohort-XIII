...
async function main() {
  ...
  const exactEthOut = ethers.parseEther("0.01"); // 0.01 ETH
  ...
  console.log(
    `Getting ${ethers.formatEther(exactEthOut)} ETH paying up to ${ethers.formatUnits(maxUsdcIn, usdcDecs)} ${usdcSym}`
  );
