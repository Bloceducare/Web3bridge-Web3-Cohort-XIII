...
//     const lock = await Lock.deploy(lotteryPrice);

//     return { lock, owner, otherAccount };
//   }
//   it("should allow Users to enter only with the exact fee", function {})
// });
...
describe("Lottery", function () {
  ...
  it("2. The contract correctly tracks 10 players", async function () {
    const { lottery, accounts, lotteryPrice } = await deployLottery();
