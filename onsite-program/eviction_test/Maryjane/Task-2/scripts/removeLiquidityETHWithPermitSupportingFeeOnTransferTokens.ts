...
async function main() {
    ...
    const lpContract = await ethers.getContractAt("IUniswapV2Pair", FEE_TOKEN_ETH_PAIR, impersonatedSigner);
    ...
    const domain = {
        ...
        version: version,
        chainId: chainId,
        verifyingContract: FEE_TOKEN_ETH_PAIR
    };
    ...
    const tx = await ROUTER.removeLiquidityETHWithPermitSupportingFeeOnTransferTokens(
        FeeTokenAddress,
        liquidityAmount,
        amountTokenMin,
        amountETHMin,
